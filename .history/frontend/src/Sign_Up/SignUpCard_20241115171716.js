    ...
    <Card variant="outlined">
      ...
      >
        ...
        <Typography variant="subtitle1" color="textSecondary">
            Rediscover your strength and independence with personalized recovery plans 
        </Typography>
        <Typography variant="body1" color="textSecondary">
          Join us to unlock access to personalized plans, connect with
          like-minded individuals, and start your journey to wellness.
        </Typography>
      </Box>
