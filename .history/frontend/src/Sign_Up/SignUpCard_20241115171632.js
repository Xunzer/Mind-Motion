...
<Box textAlign="center" sx={{ mt: 4, px: 2 }}>
  <Typography 
    ...
    sx={{ mb: 2 }}
  >
    Welcome to <Typography component="span" sx={{ color: '#1976d2' }}>Motion & Mind</Typography>
  </Typography>
  ...
  <Typography 
    ...
    sx={{ lineHeight: 1.6 }}
  >
    Track progress, stay motivated with gamified therapy, and achieve your milestones with precision and ease. 
